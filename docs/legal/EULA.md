...
PLEASE READ THIS END USER LICENSE AGREEMENT ("AGREEMENT") CAREFULLY BEFORE USING STOCKALERT.

By installing, copying, or otherwise using StockAlert ("Software"), you agree to be bound by the terms of this Agreement. If you do not agree to the terms of this Agreement, do not install or use the Software.
...
c) Use the Software for personal, non-commercial purposes

## 2. RESTRICTIONS

You may NOT:

a) Distribute, sublicense, rent, lease, or lend the Software to third parties
...
f) Use the Software for automated trading or financial transactions
...
RC SOFTWARE DOES NOT WARRANT THAT:
- The Software will meet your requirements
- The Software will be uninterrupted, timely, secure, or error-free
- The results obtained from using the Software will be accurate or reliable
- Any stock market data will be accurate, complete, or timely

## 6. LIMITATION OF LIABILITY

IN NO EVENT SHALL RC SOFTWARE BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO:

- Loss of profits, revenue, or data
- Financial losses from trading decisions
- Business interruption

WHETHER ARISING FROM CONTRACT, TORT, NEGLIGENCE, OR ANY OTHER THEORY OF LIABILITY, EVEN IF RC SOFTWARE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.

THE TOTAL LIABILITY OF RC SOFTWARE SHALL NOT EXCEED THE AMOUNT YOU PAID FOR THE SOFTWARE.

## 7. INVESTMENT DISCLAIMER

**THE SOFTWARE IS NOT INTENDED TO PROVIDE INVESTMENT ADVICE.**

- Stock alerts and price information are for informational purposes only
- You should not make investment decisions solely based on this Software
...
This license is effective until terminated. It will terminate automatically if you fail to comply with any term of this Agreement. Upon termination, you must destroy all copies of the Software.
...
**BY INSTALLING OR USING STOCKALERT, YOU ACKNOWLEDGE THAT YOU HAVE READ THIS AGREEMENT, UNDERSTAND IT, AND AGREE TO BE BOUND BY ITS TERMS AND CONDITIONS.**
